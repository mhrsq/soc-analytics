...
export function KPICards({ data, loading }: Props) {
  ...
  const cards = [
    ...
    },
    {
      ...
      bg: "bg-cyber-red/10",
      borderColor: "bg-cyber-red",
      tooltip: "Percentage of alerts confirmed as real security incidents (True Positives) out of all validated alerts.",
    },
    {
